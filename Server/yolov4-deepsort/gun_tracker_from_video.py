...
flags.DEFINE_string('video', './data/video/guns.mp4', 'path to input video or set to 0 for webcam')
flags.DEFINE_string('output', './outputs/from_video.avi', 'path to output video')
